...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-page">
      {/* Nav */}
      <header className="fixed top-0 left-0 right-0 z-50 navbar backdrop-blur-lg border-b border-theme">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/auth/login" className="text-sm font-medium text-secondary hover:text-primary transition">
              Login
            </Link>
            <Link
              href="/auth/signup"
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-4 text-center">
            <div className="inline-flex items-center gap-2 bg-tint-indigo border border-indigo-100 rounded-full px-4 py-1.5 text-sm text-accent font-medium mb-8">
            ...
            <div className="flex justify-center gap-4">
              <Link
                href="/auth/signup"
                className="bg-gray-900 text-white px-8 py-3.5 rounded-xl font-semibold hover:bg-gray-800 transition text-lg shadow-theme-sm"
              >
                Start Practicing Free
              </Link>
              <Link
                href="/auth/login"
                className="border-2 border-theme px-8 py-3.5 rounded-xl font-semibold hover:bg-elevated transition text-lg"
              >
                Sign In
              </Link>
            </div>
        ...
        {/* Stats bar */}
        <section className="border-y border-theme-light bg-elevated">
        ...
        <section className="py-20">
          <div className="max-w-5xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-primary mb-3">CLAT 2027 Pattern</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {sections.map((s) => (
                <Link key={s.name} href="/auth/signup"
                  className="group bg-card border border-theme rounded-xl p-5 hover:shadow-theme-md hover:border-indigo-200 transition-all duration-200 block">
        ...
        {/* How it works */}
        <section className="py-20 bg-gradient-to-b from-gray-50 to-white border-t border-theme-light">
          <div className="max-w-5xl mx-auto px-4">
            <div className="text-center mb-12">
      ...
      <footer className="border-t bg-card py-10">
        <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-primary">CLAT Prep Hub</span>
          </div>
