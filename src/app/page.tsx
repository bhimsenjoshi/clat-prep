      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/auth/login" className="text-sm font-medium text-gray-700 hover:text-gray-900 transition">
              Login
            </Link>
            <Link
              href="/auth/signup"
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <div className="flex justify-center gap-4">
              ...
              <Link
                href="/auth/login"
                className="border-2 border-gray-300 px-8 py-3.5 rounded-xl font-semibold hover:bg-gray-100 transition text-lg"
              >
                Sign In
              </Link>
            </div>
